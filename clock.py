...
def update_screen():
    ...
    try:
        ...
        draw.text((58, 30), round(weather_data['list'][0]['main']['temp']), font=font18, fill=255)
        ...
        draw.text((158, 30), round(weather_data['list'][1]['main']['temp']), font=font18, fill=255)
        ...
        draw.text((258, 30), round(weather_data['list'][2]['main']['temp']), font=font18, fill=255)
        ...
        draw.text((358, 30), round(weather_data['list'][3]['main']['temp']), font=font18, fill=255)
